...
from app.workflows.agentic_rag.travel_agent import (
    build_travel_agent,
)
...
def main() -> None:
    ...
    travel_agent = build_travel_agent(rag_tool)

    response = travel_agent("Can a non-refundable hotel reservation be refunded?")
